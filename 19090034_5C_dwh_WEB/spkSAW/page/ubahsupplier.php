...
<form id="form" method="POST" action="./proses/prosesubah.php">
    ...
    <div class="panel-middle">
        <div class="group-input">
            <label for="supplier" >Nama Kantin :</label>
            <input type="text" value="<?php echo $data['namaSupplier']; ?>" class="form-custom" required autocomplete="off" placeholder="Nama Kantin" id="supplier" name="supplier">
        </div>
    </div>
